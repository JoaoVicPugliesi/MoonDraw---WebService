...
describe('I confirm mail use case', () => {
  it('should fail because user does not exist', async () => {
    ...
    const iConfirmMailFactoryInMemory = new IConfirmMailFactoryInMemory(
      usersSpliced
    );
    const iConfirmMailUseCase = iConfirmMailFactoryInMemory.compose();
    const { email, token }: IConfirmMailDTO = {
      email: 'mrlanguages62@gmail.com',
      token:
        '55ac44de182e35de21c2894577841afe2c9a2372f50823dccda17553de526781a5b77e851932363d67a3ce5908fdcea3024b5b1b6fe3f3fcc410fd2415f49a57',
    };
