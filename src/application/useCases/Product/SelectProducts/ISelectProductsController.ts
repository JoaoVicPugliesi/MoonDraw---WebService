...
import { SelectProductsResponse, InvalidProductsNotFoundErrorResponse } from '@application/handlers/UseCasesResponses/Product/ISelectProductsHandlers';
...
export class ISelectProductsController {
    ...
    async handle(adapter: RequestResponseAdapter) {
        try {
            ...
            const { page }: ISelectProductsDTO = adapter.req.params as ISelectProductsDTO;
            const response: SelectProductsResponse | InvalidProductsNotFoundErrorResponse = 
